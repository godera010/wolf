    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "size-9 p-0 font-normal aria-selected:opacity-100 rounded-full hover:bg-slate-100 hover:text-slate-900"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground shadow-md scale-105 transition-all text-white font-bold",
        day_today: "bg-secondary text-white font-bold aria-selected:bg-primary aria-selected:text-primary-foreground",
        day_outside:
