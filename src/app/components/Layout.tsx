    ...
    <div className="min-h-screen flex flex-col font-['Montserrat',sans-serif] bg-[#f8fafc]">
      ...
      <main className="flex-grow relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
          ...
          <div className="absolute top-[-20%] right-[-10%] w-[900px] h-[900px] bg-gradient-to-br from-primary/15 to-transparent rounded-full blur-[120px] opacity-70" />
          <div className="absolute bottom-[-20%] left-[-10%] w-[1000px] h-[1000px] bg-gradient-to-tr from-accent/10 to-transparent rounded-full blur-[130px] opacity-50" />
